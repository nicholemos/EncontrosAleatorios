...
function rolarEncontros() {
    ...
    var terrenos = {
        "Aquático": [
            ...
            { porcentagem: 6, descricao: "1d3 bandidos comuns", pag: "Ameaças, pag 43" },
            { porcentagem: 10, descricao: "1d3 piratas", pag: "Ameaças, pag 259" },
            { porcentagem: 20, descricao: "1 baú de tesouro (ND 2; Percepção CD 15 para achar)", pag: "não possui" },
            { porcentagem: 30, descricao: "1 baú de tesouro (ND 3) e 1d4+2 piratas que acharam ele antes", pag: "não possui, Ameaças, pag 259" },
            { porcentagem: 35, descricao: "1 elfo-do-mar pescador e 1 escudeiro", pag: "Ameaças, pag 316 e 191" },
            { porcentagem: 40, descricao: "1 canceronte", pag: "Ameaças, pag 315" },
            { porcentagem: 50, descricao: "1 dragão filhote dos rios", pag: "Ameaças, pag 64" },
            { porcentagem: 60, descricao: "2 lacerons e 1 ogro", pag: "Ameaças, pag 229 e 41" },
            { porcentagem: 65, descricao: "1d3 platans", pag: "Ameaças, pag 322" },
            { porcentagem: 70, descricao: "Tempestade em alto mar*", pag: "Jogo do Ano, pag 321" },
            ...
            { porcentagem: 110, descricao: "2 águas-vivas gigantes", pag: "Ameaças, pag 319" },
            { porcentagem: 115, descricao: "1d4+1 corganns", pag: "Ameaças, pag 89" },
            { porcentagem: 125, descricao: "1 nereida", pag: "Ameaças, pag 320" },
            { porcentagem: 130, descricao: "1 peixe recife sendo atacado por 2 pliorex abissais", pag: "Ameaças, pag 321 e 325" },
            { porcentagem: 135, descricao: "1 namasqall", pag: "Ameaças, pag 91" },
            { porcentagem: 145, descricao: "1 dragão venerável dos recifes", pag: "Ameaças, pag 71" },
            { porcentagem: 150, descricao: "1 canceronte de guerra", pag: "Ameaças, pag 315" },
            { porcentagem: 155, descricao: "2 dragões veneráveis* (frio)", pag: "Jogo do Ano, pag 311" },
            { porcentagem: 160, descricao: "1 lobo do mar, 2 capitães piratas e 2d8 piratas", pag: "Ameaças, pag 263 e 259" },
        ...
        "Ártico": [
            ...
            { porcentagem: 98, descricao: "1 mamute", pag: "Ameaças, pag 350" },
            { porcentagem: 100, descricao: "1 troll das cavernas*", pag: "Ameaças, pag 353" },
            { porcentagem: 110, descricao: "2 golens de Nor enormes", pag: "Ameaças, pag 348" },
            { porcentagem: 115, descricao: "1d4+1 mamutes esqueletos", pag: "Ameaças, pag 229" },
            { porcentagem: 125, descricao: "1 dragão bicefalo (eletricidade e frio)", pag: "Ameaças, pag 72" },
            { porcentagem: 130, descricao: "1d4+2 vermes do gelo larvas", pag: "Ameaças, pag 357" },
            { porcentagem: 135, descricao: "1 fantasma ancestral e 2 fantasmas guardando um templo de Behluga com 1d4 riquezas médias", pag: "Ameaças, pag 231" },
            { porcentagem: 145, descricao: "1 hallus'tir", pag: "Ameaças, pag 93" },
            { porcentagem: 150, descricao: "2 dracomantes superiores (frio)", pag: "Ameaças, pag 27" },
            { porcentagem: 155, descricao: "2d4 lyubas com 1d3 riquezas menores presas nas patas de um deles", pag: "Ameaças, pag 27" },
            { porcentagem: 160, descricao: "1 verme do gelo adulto", pag: "Ameaças, pag 357" },
            { porcentagem: 170, descricao: "2 ezzayn", pag: "Ameaças, pag 27" },
            { porcentagem: 185, descricao: "1 necrodraco lich", pag: "Ameaças, pag 236" },
        ...
        "Área de Tormenta": [
            ...
            { porcentagem: 30, descricao: "Temperaturas implacáveis", pag: "não possui" },
            { porcentagem: 35, descricao: "1d2 maníacos lefou*", pag: "Ameaças, pag 275" },
            { porcentagem: 36, descricao: "Árvore rubra (contém 1d3 sementes carmesim)", pag: "não possui" },
            { porcentagem: 40, descricao: "1 uktril*", pag: "Ameaças, pag 265" },
            { porcentagem: 50, descricao: "1d3 infectos", pag: "não possui" },
            { porcentagem: 60, descricao: "1d4 iniciados da agonia", pag: "não possui" },
            { porcentagem: 65, descricao: "Ninho de simbiontes (Conhecimento ou Misticismo CD 25 encontra 1 dádiva de Aharadak)", pag: "não possui" },
            ...
            { porcentagem: 200, descricao: "Templo de Aharadak com um um avatar de Aharadak e 2d4 ezzayn especiais", pag: "Templos de Aharadak, pag 60" },
            { porcentagem: 999, descricao: "Gatzvalith faz promessas de poderes aos personagens", pag: "não possui" }
            // Adicione outros encontros e porcentagens aqui
        ],
        ...
        "Planície": [
            { porcentagem: 2, descricao: "1d4 bandidos comuns", pag: "não possui" },
        ...
        "Estradas": [
            ...
            { porcentagem: 10, descricao: "4 bandidos comuns tentam roubar o grupo", pag: "não possui" },
        ...
        "Galrasia": [
            { porcentagem: 2, descricao: "1 pirata fugindo de um enxame de gali-galis", pag: "não possui" },
            { porcentagem: 6, descricao: "1d4 jiboias*", pag: "não possui" },
            { porcentagem: 10, descricao: "1 dahllan drogadora (possui 1d4 bálsamos da drogadora à venda)", pag: "não possui" },
            { porcentagem: 20, descricao: "1d4+1 piratas enterrando 1 riqueza menor", pag: "não possui" },
            { porcentagem: 30, descricao: "2 najas*", pag: "não possui" },
            { porcentagem: 35, descricao: "1 galhada fêmea", pag: "não possui" },
            { porcentagem: 40, descricao: "1 matilha com 1 lobo das cavernas* e 1d4+1 lobos*", pag: "não possui" },
            { porcentagem: 50, descricao: "1 sucuri* estrangulando um gorlogg*", pag: "não possui" },
            { porcentagem: 60, descricao: "2 pteros ceifadores", pag: "não possui" },
            { porcentagem: 65, descricao: "1 espada-da-floresta montado em 1 galhada macho", pag: "não possui" },
            { porcentagem: 70, descricao: "1d3+1 ceratops guerreiros", pag: "não possui" },
            { porcentagem: 80, descricao: "2 burafontes pastando", pag: "não possui" },
            { porcentagem: 90, descricao: "1 ptero do céu infinito e 2 pteros ceifadores", pag: "não possui" },
            { porcentagem: 98, descricao: "1 gorlogg alpha e 1d4+2 gorloggs", pag: "não possui" },
            { porcentagem: 100, descricao: "1d3+1 uraghians jovens", pag: "não possui" },
            { porcentagem: 110, descricao: "1 xamã de Sarana e 1d3+1 velocis caçadores", pag: "não possui" },
            { porcentagem: 115, descricao: "1 ceratops chefe da tribo e 2d4 ceratops guerreiros", pag: "não possui" },
            { porcentagem: 125, descricao: "1 árvore-matilha", pag: "não possui" },
            { porcentagem: 130, descricao: "1 rei-tirano e 1 tuntram batalhando", pag: "não possui" },
            { porcentagem: 135, descricao: "1 obelisco misterioso obra de uma civilização antiga (na verdade é 1 tanaloom)", pag: "não possui" },
            { porcentagem: 145, descricao: "1 dragão venerável da equidade em seu covil", pag: "não possui" },
            { porcentagem: 150, descricao: "1d3+1 grande battham de passagem", pag: "não possui" },
            { porcentagem: 155, descricao: "1 razza’kham*", pag: "não possui" },
            { porcentagem: 160, descricao: "1 voracis rainha e 2d6 voracis caçadoras que vão invocar um totem da divina serpente em 1d4+1 rodadas", pag: "não possui" },
            { porcentagem: 170, descricao: "1 dragão-rei (veneno)", pag: "não possui" },
            { porcentagem: 185, descricao: "1 kaiju (ferrão peçonhento e sopro corrosivo) adormecido vai acordar em 1d3 dias", pag: "não possui" },
            { porcentagem: 200, descricao: "Conflagração elemental (1 hallustir, 1 namasqall, 1 serpentaar e 1 tanaloom)", pag: "não possui" },
            { porcentagem: 999, descricao: "1 rubi da virtude* protegido por uma armadilha Sussurro de Sszzaas(aumente a CD em 10)", pag: "não possui" },
            // Adicione outros encontros e porcentagens aqui
        ],

        "Império": [
            { porcentagem: 2, descricao: "Uma família fugindo de Tiberus", pag: "não possui" },
            { porcentagem: 6, descricao: "1 capanga", pag: "não possui" },
            { porcentagem: 10, descricao: "2 piratas", pag: "não possui" },
            { porcentagem: 20, descricao: "1 legionário", pag: "não possui" },
            { porcentagem: 30, descricao: "2 bandidos selvagens", pag: "não possui" },
            { porcentagem: 35, descricao: "4 cavalos de carga desgovernados", pag: "não possui" },
            { porcentagem: 40, descricao: "1 infecto", pag: "não possui" },
            { porcentagem: 50, descricao: "2 capangas minotauros", pag: "não possui" },
            { porcentagem: 60, descricao: "2 maníacos lefou* e 1 iniciado da agonia", pag: "não possui" },
            { porcentagem: 65, descricao: "1 capelão de guerra pregando a palavra de Arsenal", pag: "não possui" },
            { porcentagem: 70, descricao: "1 minauro arcanista estudando", pag: "não possui" },
            { porcentagem: 80, descricao: "3 pistoleiros atrás de um tesouro de ND 8 em um cemitério tapistano", pag: "não possui" },
            { porcentagem: 90, descricao: "2 decúrias", pag: "não possui" },
            { porcentagem: 98, descricao: "Um gladiador lefou oferecendo abrigo contra a tempestade (Descanso confortável)", pag: "não possui" },
            { porcentagem: 100, descricao: "4 arqueiros escravos e 1 governador corrupto", pag: "não possui" },
            { porcentagem: 110, descricao: "Uma arena com lutas individuais contra gladiadores táuricos", pag: "não possui" },
            { porcentagem: 115, descricao: "Armadilha viva", pag: "não possui" },
            { porcentagem: 125, descricao: "1 chapéu-preto atrás de um escravo foragido", pag: "não possui" },
            { porcentagem: 130, descricao: "1 mordagrel", pag: "não possui" },
            { porcentagem: 135, descricao: "Uma formação rubra que infecta quem a tocar com Náusea Antinatural", pag: "não possui" },
            { porcentagem: 145, descricao: "1 arquibruxo da tormenta e 2 bandos de uktril* (ND 10)", pag: "não possui" },
            { porcentagem: 150, descricao: "1 senhor do gigante rubro, forma final", pag: "não possui" },
            { porcentagem: 155, descricao: "1 ezzayn", pag: "não possui" },
            { porcentagem: 160, descricao: "2 elementais corrompidos enfrentando 1 bando de centuriões de elite (ND 15)", pag: "não possui" },
            { porcentagem: 170, descricao: "Um grupo de arcanistas tapistanos realizando testes com uma Armadura do Devorador", pag: "não possui" },
            { porcentagem: 185, descricao: "4 thuwarokks", pag: "não possui" },
            { porcentagem: 200, descricao: "1 avatar de aharadak em uma Área de Tormenta", pag: "não possui" },
            { porcentagem: 999, descricao: "A Marcha da Centúria Rubra (1 Avatar de Aharadak, 1 bando de Zyrrinaz (ND 16), 2d4 reishids líderes de culto, 2 bandos de legionários insanos (ND 17), e 1 arquibruxo da tormenta conjurando Momento de Tormenta)", pag: "não possui" }
            // Adicione outros encontros e porcentagens aqui
        ],


        "Repúblicas": [
            { porcentagem: 2, descricao: "1 malafex curioso acompanha o grupo, role novamente", pag: "não possui" },
            { porcentagem: 6, descricao: "1d3+1 cascavéis*", pag: "não possui" },
            { porcentagem: 10, descricao: "1d4 lobos*", pag: "não possui" },
            { porcentagem: 20, descricao: "1 pirata e 2 bandidos comuns", pag: "não possui" },
            { porcentagem: 30, descricao: "1d4 t’peels tentam roubar os aventureiros", pag: "não possui" },
            { porcentagem: 35, descricao: "1d4+1 perdigueiros trolls", pag: "não possui" },
            { porcentagem: 40, descricao: "1 cocatriz", pag: "não possui" },
            { porcentagem: 50, descricao: "1 uktril perdido", pag: "não possui" },
            { porcentagem: 60, descricao: "1 hynne dormente que nunca vai trair os aventureiros. Ele prometeu.", pag: "não possui" },
            { porcentagem: 65, descricao: "1 serpe lutando contra 1 grifo*", pag: "não possui" },
            { porcentagem: 70, descricao: "2 fúrias de tauron 1 otyugh", pag: "não possui" },
            { porcentagem: 80, descricao: "1 tendrículo escondido", pag: "não possui" },
            { porcentagem: 90, descricao: "1 ente salgueiro protegendo seu precioso jardim", pag: "não possui" },
            { porcentagem: 98, descricao: "2 kallyanach bárbaros", pag: "não possui" },
            { porcentagem: 100, descricao: "1 homem-piranha capitão, 1 homem-piranha imediato e 2 homens-piranha", pag: "não possui" },
            { porcentagem: 110, descricao: "1 reishid e 1 sacerdote da agonia preparam um sacrifício", pag: "não possui" },
            { porcentagem: 115, descricao: "1 bando de pamgras", pag: "não possui" },
            { porcentagem: 125, descricao: "1 dragão bicéfalo", pag: "não possui" },
            { porcentagem: 130, descricao: "1 alto sacerdote fintroll e 2 cavaleiros fintroll", pag: "não possui" },
            { porcentagem: 135, descricao: "1 dracomante superior (ácido) extorquindo comerciantes", pag: "não possui" },
            { porcentagem: 145, descricao: "1 dragão venerável dos recifes afundando um navio pirata", pag: "não possui" },
            { porcentagem: 150, descricao: "1 namasquall e 1 hallustir atacando uma vila portuária", pag: "não possui" },
            { porcentagem: 155, descricao: "1 reishid líder de culto e 4 líderes fanáticos lefou espalhando a palavra de seu salvador", pag: "não possui" },
            { porcentagem: 170, descricao: "1 templo de aharadak onde um senhor do gigante rubro forma final está reunindo novos cultistas oferecendo 1 dádiva de aharadak", pag: "não possui" },
            { porcentagem: 170, descricao: "1 lich de Aslothia e 4 alzeras", pag: "não possui" },
            { porcentagem: 185, descricao: "1 riqueza maior no fundo de um rio de água corrente protegida por 1d4+1 elementais corrompidos", pag: "não possui" },
            { porcentagem: 200, descricao: "1 kraken e 2d4+2 corgans atacando uma cidade portuária", pag: "não possui" },
            { porcentagem: 999, descricao: "Covil dos escamas verdes (1 dragão-rei (ácido) e 2d4 dragões veneráveis (ácido))", pag: "não possui" }
            // Adicione outros encontros e porcentagens aqui
        ],

        "Sanguinárias": [
            { porcentagem: 2, descricao: "Ninho de 1d4+1 cascavéis*", pag: "não possui" },
            { porcentagem: 4, descricao: "1 trog anão bruto caçando", pag: "não possui" },
            { porcentagem: 6, descricao: "1 terrier querendo brincar", pag: "não possui" },
            { porcentagem: 10, descricao: "1 leão cochilando", pag: "não possui" },
            { porcentagem: 20, descricao: "1d4 enxames larvais", pag: "não possui" },
            { porcentagem: 35, descricao: "1 aranha gigante* em seu covil", pag: "não possui" },
            { porcentagem: 40, descricao: "1d3+1 lagartos perseguidores", pag: "não possui" },
            { porcentagem: 50, descricao: "1 lobo-das-cavernas* e 2 lobos*", pag: "não possui" },
            { porcentagem: 60, descricao: "1 avalanche", pag: "não possui" },
            { porcentagem: 65, descricao: "1 gigante esqueleto", pag: "não possui" },
            { porcentagem: 70, descricao: "1d3+1 grifos*", pag: "não possui" },
            { porcentagem: 80, descricao: "1d4+1 cerianthar preparando uma emboscada", pag: "não possui" },
            { porcentagem: 90, descricao: "1 centopeia-dragão*", pag: "não possui" },
            { porcentagem: 98, descricao: "4 cães do inferno*", pag: "não possui" },
            { porcentagem: 100, descricao: "1d4+2 basiliscos*", pag: "não possui" },
            { porcentagem: 110, descricao: "2 serpes anciãs", pag: "não possui" },
            { porcentagem: 115, descricao: "1d3+1 uraghian adulto", pag: "não possui" },
            { porcentagem: 125, descricao: "2 oxxodon imensos e 1 arcano de guerra veterano", pag: "não possui" },
            { porcentagem: 130, descricao: "Role novamente, o próximo encontro está sob efeito de um fenômeno rubro aleatório", pag: "não possui" },
            { porcentagem: 135, descricao: "1 mantícora primal", pag: "não possui" },
            { porcentagem: 145, descricao: "1 templo de Kallyadranoch defendido por 1 alto clérigo de Kally e 2 cavaleiros de Kally", pag: "não possui" },
            { porcentagem: 150, descricao: "1 grande tachygloss", pag: "não possui" },
            { porcentagem: 155, descricao: "1 vagalhão kobold", pag: "não possui" },
            { porcentagem: 160, descricao: "2 razza’kham caçando 4 cavaleiros do leopardo sangrento*", pag: "não possui" },
            { porcentagem: 170, descricao: "2 ezzayn especiais", pag: "não possui" },
            { porcentagem: 185, descricao: "1 dragão-rei (fogo)*", pag: "não possui" },
            { porcentagem: 200, descricao: "2 kaiju brigando por território", pag: "não possui" },
            { porcentagem: 999, descricao: "Kishinauros em seu local de descanso", pag: "não possui" }
            // Adicione outros encontros e porcentagens aqui
        ],

        "Supremacia": [
            { porcentagem: 1, descricao: "recruta purista*", pag: "não possui" },
            ...
            { porcentagem: 6, descricao: "4 goblins salteadores* fugitivos", pag: "não possui" },
            { porcentagem: 11, descricao: "chefe bandido", pag: "não possui" },
            { porcentagem: 21, descricao: "purificado fugitivo", pag: "não possui" },
            { porcentagem: 31, descricao: "1d4+2 recruta purista*", pag: "não possui" },
            { porcentagem: 35, descricao: "sargento-mor*", pag: "não possui" },
            { porcentagem: 40, descricao: "1d4 soldados puristas*", pag: "não possui" },
            { porcentagem: 50, descricao: "2 acólitos de Kally", pag: "não possui" },
            { porcentagem: 60, descricao: "1d4+2 recrutas puristas* e 1 sargento-mor*", pag: "não possui" },
            { porcentagem: 65, descricao: "dançarino de guerra e 2 bandidos selvagens", pag: "não possui" },
            { porcentagem: 70, descricao: "2 capelães de guerra*", pag: "não possui" },
            { porcentagem: 80, descricao: "2 soldados blindados", pag: "não possui" },
            { porcentagem: 90, descricao: "dançarino de guerra veterano e 2 capelães de guerra*", pag: "não possui" },
            { porcentagem: 98, descricao: "capelão de guerra*, 1 capitão-baluarte* e 2 sargentos-mor*", pag: "não possui" },
            { porcentagem: 100, descricao: "1d6+1 guerreiros perpétuos", pag: "não possui" },
            { porcentagem: 110, descricao: "2 caçadores de impuros e 1 cavaleiro do leopardo sangrento*", pag: "não possui" },
            { porcentagem: 115, descricao: "companhia blindada de elite", pag: "não possui" },
            { porcentagem: 125, descricao: "arcano de guerra veterano e 2 golens de bronze", pag: "não possui" },
            { porcentagem: 130, descricao: "fantasma ancestral, morto na batalha do Vale do Baixo Iörvaen", pag: "não possui" },
            { porcentagem: 135, descricao: "kishin e 1d6+2 bispos de guerra", pag: "não possui" },
            { porcentagem: 145, descricao: "concílio forjador combatendo 1 alto clérigo de Kally montado num dragão adulto*", pag: "não possui" },
            { porcentagem: 150, descricao: "golem de ferro superior e 1 colosso supremo*", pag: "não possui" },
            { porcentagem: 155, descricao: "arcanos de guerra veteranos montados em carruagens de comando, escoltando 4 colossos supremos* desativados", pag: "não possui" },
            { porcentagem: 170, descricao: "golens de ferro superiores e 1 soldado superior", pag: "não possui" },
            { porcentagem: 185, descricao: "colossos supremos*, 2 golens de ferro superiores e 1 soldado superior", pag: "não possui" },
            { porcentagem: 200, descricao: "1d6+2 soldados superiores", pag: "não possui" },
            { porcentagem: 999, descricao: "Comando do Templo da Pureza Divina (1 kishinauros, 1d6 colossos supremos*, 2d6 bispos de guerra)", pag: "não possui" }
            // Adicione outros encontros e porcentagens aqui
        ],

        "Lamnor": [
            { porcentagem: 2, descricao: "1d4+1 goblins salteadores", pag: "não possui" },
            { porcentagem: 6, descricao: "2d4 ratos gigantes", pag: "não possui" },
            { porcentagem: 10, descricao: "1 bandido ligeiro e 2 bandidos comuns", pag: "não possui" },
            { porcentagem: 20, descricao: "1 zumbi peçonha", pag: "não possui" },
            { porcentagem: 30, descricao: "1 turba de zumbis*", pag: "não possui" },
            { porcentagem: 35, descricao: "1 leão disputando uma carcaça com 1 pantera", pag: "não possui" },
            { porcentagem: 36, descricao: "1 ogro-esqueleto", pag: "não possui" },
            { porcentagem: 40, descricao: "1 goblin engenhoqueiro* querendo fazer comércio", pag: "não possui" },
            { porcentagem: 50, descricao: "1 imediato e 1d4+1 piratas", pag: "não possui" },
            { porcentagem: 60, descricao: "1 arauto de Thwor em peregrinação", pag: "não possui" },
            { porcentagem: 65, descricao: "1 tigre-de-hynnin", pag: "não possui" },
            { porcentagem: 80, descricao: "1 hobgoblin mago de batalha e 2 hobgoblin soldados", pag: "não possui" },
            { porcentagem: 90, descricao: "1 líder goblin de sombreiro e 1d3+1 bugbear sentinela", pag: "não possui" },
            { porcentagem: 98, descricao: "Ruínas com 1d4+1 riquezas menores começam a desabar (use o perigo complexo construção em colapso)", pag: "não possui" },
            { porcentagem: 100, descricao: "1 goblin de ferro mark II e 4 goblin-bomba", pag: "não possui" },
            { porcentagem: 110, descricao: "1 devorador de medos* e 2 bugbears guarda-costas", pag: "não possui" },
            { porcentagem: 115, descricao: "2 sombras de thwor* tentam assassinar um dos aventureiros", pag: "não possui" },
            { porcentagem: 125, descricao: "1 engenho de guerra goblin* escoltado por 1 hobgoblin comandante tático e 2 hobgoblins atiradores", pag: "não possui" },
            { porcentagem: 130, descricao: "lodo negro surge em um quadrado desocupado e dobra sua área a cada rodada. Role novamente.", pag: "não possui" },
            { porcentagem: 135, descricao: "1 horda goblin", pag: "não possui" },
            { porcentagem: 145, descricao: "Ruínas de uma cidade com 1 fantasma ancestral e 4 fantasmas", pag: "não possui" },
            { porcentagem: 150, descricao: "1 necrodraco zumbi submerso num lago de lodo negro", pag: "não possui" },
            { porcentagem: 155, descricao: "1d4+2 tigres-de-Hynninn primordiais", pag: "não possui" },
            { porcentagem: 160, descricao: "1 cemitério vivo", pag: "não possui" },
            { porcentagem: 170, descricao: "1 lobo do mar e 4 capitães da frota áurea carregando baú com 1d3 riquezas maiores protegida por 1 runa da desintegração (aumente a CD em 5)", pag: "não possui" },
            { porcentagem: 185, descricao: "1 hobgoblin gladiador e seu conselheiro espiritual clérigo de Thwor (um sszzaazita celebrante disfarçado)", pag: "não possui" },
            { porcentagem: 200, descricao: "1 necrodraco lich tentando reerguer uma vila, ele invoca uma falange a cada 1d4 rodadas", pag: "não possui" },
            { porcentagem: 999, descricao: "1 sangue do Ayrrak, 4 hobgoblins gladiadores e 2 bruxas goblins convidam os aventureiros a se juntarem as suas tropas. A força.", pag: "não possui"}
        ]
